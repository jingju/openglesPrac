...
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_SET_GRAVITY_XY;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_SET_TOUCH_LOC;
/**
 * @author: Macro
 * @description:
...
public class MyGLRender implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        Log.d(TAG, "onSurfaceCreated() called with: GL_VERSION = [" + gl.glGetString(GL10.GL_VERSION) + "]");
