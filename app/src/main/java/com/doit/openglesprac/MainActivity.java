...
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_BEATING_HEART;
import static com.doit.openglesprac.MyGLSurfaceView.IMAGE_FORMAT_GARY;
import static com.doit.openglesprac.MyGLSurfaceView.IMAGE_FORMAT_NV21;
import static com.doit.openglesprac.MyGLSurfaceView.IMAGE_FORMAT_RGBA;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_BASIC_LIGHTING;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_BLENDING;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_COORD_SYSTEM;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_DEPTH_TESTING;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_EGL;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_FBO;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_FBO_LEG;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_INSTANCING;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_AVATAR;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_BEATING_HEART;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_BEZIER_CURVE;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_BIG_EYES;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_BIG_HEAD;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_BINARY_PROGRAM;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_BLIT_FRAME_BUFFER;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_CLOUD;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_COPY_TEXTURE;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_FACE_SLENDER;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_FBO_BLIT;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_HWBuffer;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_MRT;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_MULTI_THREAD_RENDER;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_RGB2I420;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_RGB2I444;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_RGB2NV21;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_RGB2YUYV;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_ROTARY_HEAD;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_SCRATCH_CARD;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_SHOCK_WAVE;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_STAY_COLOR;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_TBO;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_TEXT_RENDER;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_TIME_TUNNEL;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_TRANSITIONS_1;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_TRANSITIONS_2;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_TRANSITIONS_3;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_TRANSITIONS_4;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_UBO;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_KEY_VISUALIZE_AUDIO;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_MULTI_LIGHTS;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_PARTICLES;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_PBO;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_SKYBOX;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_STENCIL_TESTING;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_TEXTURE_MAP;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_TRANS_FEEDBACK;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_TRIANGLE;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_VAO;
import static com.doit.openglesprac.MyNativeRender.SAMPLE_TYPE_YUV_TEXTURE_MAP;
...
import com.doit.openglesprac.adapter.MyRecyclerViewAdapter;
